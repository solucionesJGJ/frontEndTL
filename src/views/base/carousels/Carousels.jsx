...
/* import `https://coreui.io/react/demo/3.0/assets/images/react.jpg` from 'src/assets/images/angular.jpg'
import `https://coreui.io/react/demo/3.0/assets/images/react.jpg` from 'src/assets/images/react.jpg'
import `https://coreui.io/react/demo/3.0/assets/images/react.jpg` from 'src/assets/images/vue.jpg' */
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/carousel">
              <CCarousel>
                <CCarouselItem>
                  <img className="d-block w-100" src={`https://coreui.io/react/demo/3.0/assets/images/react.jpg`} alt="slide 1" />
                </CCarouselItem>
                <CCarouselItem>
                  <img className="d-block w-100" src={`https://coreui.io/react/demo/3.0/assets/images/react.jpg`} alt="slide 2" />
                </CCarouselItem>
                <CCarouselItem>
                  <img className="d-block w-100" src={`https://coreui.io/react/demo/3.0/assets/images/react.jpg`} alt="slide 3" />
                </CCarouselItem>
              </CCarousel>
            </DocsExample>
          </CCardBody>
